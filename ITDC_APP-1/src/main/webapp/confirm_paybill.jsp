<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
 ...
 <title>Insert title here</title> </head> <body  bgcolor="#DDDDDD"> 
 <center>
 <body bgcolor="pink">

        <h2 >SELECT ROOMS PAGE</h2>   
                   ...
                   <input type="hidden" name=HotelName value="${h.getHotelName() }">  
                               ...
                               <p>No Of Rooms</p>       
                                                  <input type="hidden" name=wrooms value="${bd.getWrooms() }"> <h3>${bd.getWrooms()}</h3>  
                              ...
                              <p>No Of Days</p>   
                                             ...
                                             <input type="hidden" name=days value="${bd.getDays() }">  <h3>${bd.getDays()}</h3>       
